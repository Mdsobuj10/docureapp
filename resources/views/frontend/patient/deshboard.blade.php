								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="{{asset('frontend/assets/img/patients/patient.jpg')}}" alt="User Image">
										</a>
															...
															<tbody>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{asset('frontend/assets/img/doctors/doctor-thumb-02.jpg')}}" alt="User Image">
																			</a>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{asset('frontend/assets/img/doctors/doctor-thumb-07.jpg" alt="User Image')}}">
																			</a>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{asset('frontend/assets/img/doctors/doctor-thumb-08.jpg" alt="User Image')}}" alt="User Image">
																			</a>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="doctor-profile.html" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="{{asset('frontend/assets/img/doctors/doctor-thumb-10.jpg" alt="User Image')}}" alt="User Image">
																			</a>
